================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : iHR320 Project Overview
===============================================================================

The application wizard has created this iHR320 application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your iHR320 application.
...
res\iHR320.ico
    ...
    icon is included by the main resource file iHR320.rc.
...
iHR320Dlg.h, iHR320Dlg.cpp - the dialog
    These files contain your CiHR320Dlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in iHR320.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CiHR320DlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named iHR320.pch and a precompiled types file named StdAfx.obj.
